    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                {!! Form::open(['action' => ['CusportalController@updateCompany', $company->id],'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group">
                        {{Form::label('name', 'Company Name')}}
                        {{Form::text('name', $company->name, ['class' => 'form-control', 'placeholder' => 'Company Name', 'disabled' => 'true'])}}
                    </div>
                    <div class="form-group">

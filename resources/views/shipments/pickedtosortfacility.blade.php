...
<div class="panel-heading"><h1>Shipments - Picked from Customer</h1> </div>
{!! Form::open(['action' => 'TxnsController@receiveatsortShipments', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}

<br>
{{Form::submit('Receive Shipments at Sort Facility', ['class'=>'btn btn-primary', 'id' => 'submit-btn'])}}
<br><br>
@if(count($txns) > 0)
<?php
	$colcount = count($txns);
